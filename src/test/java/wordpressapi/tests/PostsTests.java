    ...
    public void retrievePostTest() {
        ...
        getBasicAuth()
                ...
                .body("id", equalTo(newPostId),
                        ...
                        "categories", hasSize(1),
                        "categories[0]", equalTo(1),
                        "tags", empty(),
                        "class_list", hasSize(7),
